...
public class NetServerHandler extends NetHandler
{
    ...
    public void handleBlockDig(Packet14BlockDig par1Packet14BlockDig)
    {
        ...
        else
        {
            ...
            if (par1Packet14BlockDig.status == 0)
            {
                ...
                {
                    this.playerEntity.theItemInWorldManager.blockClicked(var5, var6, var7, par1Packet14BlockDig.face);
                }
            }
            else if (par1Packet14BlockDig.status == 2)
            {
                this.playerEntity.theItemInWorldManager.blockRemoving(var5, var6, var7);
    ...
    public void handlePlace(Packet15Place par1Packet15Place)
    {
        ...
        if (var3 == null || var3.getMaxItemUseDuration() == 0)
        {
            ...
            {
                this.sendPacket(new Packet103SetSlot(this.playerEntity.openContainer.windowId, var13.slotNumber, this.playerEntity.inventory.getCurrentItem()));
            }
        }
    }
